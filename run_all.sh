...
# Second Stage
python test_2.py -task imdb -editor_path results/imdb/editors/mmice-test-editor-ber/checkpoints -stage2_exp mmice-test-editor-bert -n_samples 500 -model_name bert-base-uncased